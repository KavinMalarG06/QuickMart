...
const Products = () => {
  return (
    <div className='mt-14 mb-12 dark:bg-gray-800 dark:text-white'>
        ...
        <div className='text-center mb-10 max-w-[600px] mx-auto'>
            ...
            <p data-aos='fade-up' 
            className='text-xs text-black'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque magni tenetur veniam.</p>
        </div>
        {/* body section */}
        <div>
